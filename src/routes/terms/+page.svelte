...
<svelte:head>
    <title>CS2 Giveaways - Terms of Service</title>
    ...
    <main class="flex-grow relative z-0">
        ...
        <div class="container mx-auto max-w-5xl px-4 py-12 relative z-10">
            ...
            <div class="text-center" style="margin-top: 100px;">
                <a href="https://www.digipulation.com/TOS" class="px-5 py-2 bg-yellow-500 hover:bg-yellow-400 text-black font-bold text-sm rounded shadow-[0_0_15px_rgba(234,179,8,0.2)] hover:shadow-[0_0_20px_rgba(234,179,8,0.4)] transition-all transform hover:-translate-y-0.5 active:translate-y-0">
